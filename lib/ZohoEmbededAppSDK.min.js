...
typeof a&&(a.appOrigin=encodeURIComponent(window.location.href));if(!p)throw Error("Parentwindow reference not found.");p.postMessage(a,k.QueryParams.serviceOrigin)}var k,x=ZSDKUtil.getLogger(),m=100,a={},w=/^https?:\/\/[a-zA-Z0-9-_]*.(sandbox.crm-oem.com|sandbox.localzoho.com|csez.zohocorpin.com|zoho.com|localzoho.com|zohoplatform.com|localzohoplatform.com|zohosandbox.com|localzohosandbox.com)(:[0-9]{0,4})?$/,q=!1,p,r,n={};b.Init=function(a,c){if(!a||"object"!==typeof a)throw Error("Invalid Context object passed");
if(c&&"object"!==typeof c)throw Error("Invalid Configuration Passed to MessageManager");k=a;return f.bind(b)};b.RegisterApp=function(){var a={type:"SDK.EVENT",eventName:"REGISTER",appOrigin:encodeURIComponent(window.location.href)};window.top.postMessage(a,k.QueryParams.serviceOrigin)};b.DERegisterApp=function(){var a={type:"SDK.EVENT",eventName:"DEREGISTER",uniqueID:k.getUniqueID()};e(a)};b.SendRequest=function(a){if(!a||"object"!==typeof a)throw Error("Invalid Options passed");if(a.connector&&ZSDKUtil.isDevMode()){var b=
